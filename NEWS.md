# BiocChallenges 0.0.4

* Query the datetime of the latest push to each contributing repository.
* Cache queries to the GitHub API for individual repositories.

# BiocChallenges 0.0.3
